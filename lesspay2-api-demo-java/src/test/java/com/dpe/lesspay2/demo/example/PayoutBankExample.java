...
/**
 * Payout Supported Banks API Call Example
 * 
 * Demonstrates how to call the /api/global/payout/bank endpoint
 * 
 * Usage:
 * 1. Modify the APP_ID, APP_SECRET, BASE_URL configuration below
 * 2. Run the testPayoutBankDemo() test method
 */
public class PayoutBankExample {
    ...
    /**
     * Payout Supported Banks API call test
     */
    @Test
    public void testPayoutBankDemo() throws IOException {
        System.out.println("========== Payout Bank Demo Start ==========");

        // 1. Build request parameters
        PayoutBankDTO dto = buildPayoutBankRequest();
    ...
    /**
     * Build Payout Bank request parameters
     */
    private PayoutBankDTO buildPayoutBankRequest() {
        PayoutBankDTO dto = new PayoutBankDTO();

        // Bank Country Code (ISO 3166-1 alpha-2)
        // Examples: PH (Philippines), IN (India), ID (Indonesia)
        dto.setBankCountryCode("PH");

        // Target Currency, 3-letter currency code
        // Examples: PHP, INR, IDR
        dto.setCurrency("PHP");
